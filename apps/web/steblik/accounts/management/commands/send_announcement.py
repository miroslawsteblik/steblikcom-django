...
from apps.web.steblik.accounts.models import Announcement
from apps.web.steblik.accounts.services import send_announcement
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            ...
            raise CommandError(f"Announcement {options['announcement_id']} not found.") from None
