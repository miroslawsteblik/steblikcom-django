    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body_html', models.TextField(blank=True, help_text='HTML email body (optional — falls back to plain text).')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('announcement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipients', to='accounts.announcement')),
            ],
            options={
                'ordering': ['email'],
            },
